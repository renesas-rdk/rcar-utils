...
- **--image_fip**: Path to the TF-A FIP image for legacy boards.
...
- See the main [`universal-scripts/host/tools/README.md`](../README.md#r-car-v4h-sparrow-hawk-flashing-flow) for the full flow diagram and comparison with the legacy boards.
...
- Require the legacy `--image_bl2`/`--image_bl2_esd` pair, plus `--image_bid`
